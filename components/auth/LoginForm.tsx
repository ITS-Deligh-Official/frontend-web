...
export default function LoginForm() {
  ...
  return (
    <>
      <AuthHeader title="Welcome Back" subtitle="Continue your professional learning journey." />
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="mt-8 space-y-5">
        ...
        <RememberMe checked={!!rememberMe} onCheckedChange={(v) => setValue("rememberMe", v)} />
        ...
        <SocialLogin
          onGoogleClick={() =>
            toast.info("Google sign-in will be available once OAuth is configured on the backend.")
          }
        />
