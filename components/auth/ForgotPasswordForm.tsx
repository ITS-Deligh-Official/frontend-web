...
export default function ForgotPasswordForm() {
  ...
  return (
    <>
      ...
      {sent ? (
        <div className="mt-8 rounded-lg bg-emerald-50 p-4 text-sm text-emerald-700">
      ...
      <AuthFooter>
        <Link href="/login" className="inline-flex items-center gap-1 font-medium text-violet-600 hover:underline">
